...
import numpy as np
import evaluation
from tests.resource.evaluation.file_type_hints_collector.sample_to_import import (
...
class A:
    ...
    def function(self, a: pathlib.Path, b: Path) -> bool:
        ...
        h: typing.Union[
            list[str],
            dict[None | evaluation.FileTypeHintsCollector, dict[float, Optional[bool | int]]],
        ] = ...
        return c
